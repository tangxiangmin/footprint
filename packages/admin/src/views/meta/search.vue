<template>
  <el-form ref="searchForm" :model="params" label-width="100px">
      ...
      <el-col :span="8">
        <el-form-item label="事件value">
          <el-select v-model="params.eventValue" placeholder="请选择">
            ...
            <el-option
              v-for="item in currentEventList"
              :label="`${item.name}【${item.eventValue}】`"
    ...
    <el-row>
      <el-col :span="8">
        <el-form-item label="页面来源">
          <el-input v-model="params.utmSource" type="text" placeholder="可以从追踪参数出获取列表" />
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="来源位置">
          <el-input v-model="params.utmCampaign" type="text" />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-form-item>
        <el-button v-loading="isLoading" type="primary" @click="search">点击查询</el-button>
      </el-form-item>
    </el-row>
  </el-form>
</template>
